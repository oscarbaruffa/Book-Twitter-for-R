...
The online R community is known as a friendly bunch! Some even say the community is R's greatest asset. The community tries to create a safe space where it's OK to ask questions.  People support each other and are genuinly happy for each other if there is good news to share. 
