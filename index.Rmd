...
<br/><br/>
If you are into data visualisation, you can learn a lot from participating in Tidy Tuesday. You can read more about Tidy Tuesday [later in this book](https://bookdown.org/oscar_baruffa/Book-Twitter-for-R/hashtags-what-are-they-good-for.html#tidytuesday), and on the [Tidy Tuesday github page](https://github.com/rfordatascience/tidytuesday). 
